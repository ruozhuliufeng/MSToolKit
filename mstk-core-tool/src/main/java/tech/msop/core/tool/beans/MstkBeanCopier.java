 ...
 */
public abstract class MstkBeanCopier {
	private static final Type CONVERTER = TypeUtils.parseType("org.springframework.cglib.core.Converter");
	private static final Type BEAN_COPIER = TypeUtils.parseType(MstkBeanCopier.class.getName());
	...
	/**
	 * The map to store {@link MstkBeanCopier} of source type and class type for copy.
	 */
	private static final ConcurrentMap<MstkBeanCopierKey, MstkBeanCopier> BEAN_COPIER_MAP = new ConcurrentHashMap<>();

	public static MstkBeanCopier create(Class source, Class target, boolean useConverter) {
		return MstkBeanCopier.create(source, target, useConverter, false);
	}

	public static MstkBeanCopier create(Class source, Class target, boolean useConverter, boolean nonNull) {
		MstkBeanCopierKey copierKey = new MstkBeanCopierKey(source, target, useConverter, nonNull);
	...
	public static class Generator extends AbstractClassGenerator {
		private static final Source SOURCE = new Source(MstkBeanCopier.class.getName());
		...
		@Override
		public MstkBeanCopier create(Object key) {
			return (MstkBeanCopier) super.create(key);
		}
