 ...
 */
public class MstkNumberModule extends SimpleModule {
	public static final MstkNumberModule INSTANCE = new MstkNumberModule();

	public MstkNumberModule() {
		super(MstkNumberModule.class.getName());
