...
import tech.msop.core.tool.beans.MstkBeanCopier;
import tech.msop.core.tool.beans.MstkBeanMap;
import tech.msop.core.tool.convert.MstkConverter;
...
public class BeanUtil extends org.springframework.beans.BeanUtils {
	...
	public static <T> T copy(@Nullable Object source, Class sourceClazz, Class<T> targetClazz) {
		...
		MstkBeanCopier copier = MstkBeanCopier.create(sourceClazz, targetClazz, false);
	...
	public static void copy(@Nullable Object source, @Nullable Object targetBean) {
		...
		MstkBeanCopier copier = MstkBeanCopier
	...
	public static <T> T copyWithConvert(@Nullable Object source, Class<?> sourceClazz, Class<T> targetClazz) {
		...
		MstkBeanCopier copier = MstkBeanCopier.create(sourceClazz, targetClazz, true);
		T to = newInstance(targetClazz);
		copier.copy(source, to, new MstkConverter(sourceClazz, targetClazz));
		return to;
	}
	...
	public static Map<String, Object> toMap(@Nullable Object bean) {
		...
		return MstkBeanMap.create(bean);
	}
