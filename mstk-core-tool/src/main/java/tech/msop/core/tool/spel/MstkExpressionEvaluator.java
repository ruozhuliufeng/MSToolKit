 ...
 * @author L.cm
 */
public class MstkExpressionEvaluator extends CachedExpressionEvaluator {
	...
	public EvaluationContext createContext(Method method, Object[] args, Object target, Class<?> targetClass, @Nullable BeanFactory beanFactory) {
		...
		MstkExpressionRootObject rootObject = new MstkExpressionRootObject(method, args, target, targetClass, targetMethod);
