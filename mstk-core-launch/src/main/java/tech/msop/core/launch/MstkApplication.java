...
public class MstkApplication {
    ...
    public static SpringApplicationBuilder createSpringApplicationBuilder(String appName, Class source, String... args) {
        ...
        String startJarPath = MstkApplication.class.getResource("/").getPath().split("!")[0];
        ...
        props.setProperty("mstk.env", profile);
        props.setProperty("mstk.name", appName);
        props.setProperty("mstk.is-local", String.valueOf(isLocalDev()));
        props.setProperty("mstk.dev-mode", profile.equals(AppConstant.PROD_CODE) ? "false" : "true");
        props.setProperty("mstk.service.version", AppConstant.APPLICATION_VERSION);
